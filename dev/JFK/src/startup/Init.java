	...
	public static void initialize(){
		...
		try{
			...
			if (!userExistsOrError){
				User user = new User(EnvConfiguration.getDefaultUsername(), AuthorizationUtil.scramblePassword(EnvConfiguration.getDefaultUserPassword()), "juliakost@t-online.de");
				s.save(user);
				tx.commit();				
			}
		} catch (Exception e){
